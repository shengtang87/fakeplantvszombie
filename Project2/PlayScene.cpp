        ...
        for(int j = 0 ; j < std::get<2>(current) ; j++){
            ...
            switch (std::get<0>(current)) {
				...
				case 3:
					...
					break;
				case 4:
					EnemyGroup->AddNewObject(enemy = new HandsomeEnemy(SpawnCoordinate.x, SpawnCoordinate.y));
					break;
				case 5:
...
void PlayScene::clean(int x, int y) {
...
void PlayScene::ConstructUI() {
	...
	btn = new TurretButton("play/floor.png", "play/dirt.png",
		...
		, 410, 128 * MapHeight, FlameTurret::Price);
	// Reference: Class Member Function Pointer and std::bind.
	...
	btn = new TurretButton("play/floor.png", "play/dirt.png",
		...
		, 530, 128 * MapHeight, BlockTurret::Price);
	// Reference: Class Member Function Pointer and std::bind.
...
void PlayScene::UIBtnClicked(int id) {
	...
	else if (id == 2 && money >= FlameTurret::Price)
		preview = new FlameTurret(0, 0);
	else if (id == 3 && money >= BlockTurret::Price)
		preview = new BlockTurret(0, 0);
	else if (id == 4 && money >= BombTurret::Price)
		preview = new BombTurret(0, 0);
	else if (id == 5 && money >= Fkoff::Price)
		preview = new Fkoff(0, 0);
	if (!preview)
		return;
	preview->Position = Engine::GameEngine::GetInstance().GetMousePosition();
